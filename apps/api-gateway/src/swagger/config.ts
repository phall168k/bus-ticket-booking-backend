...
export const SWAGGER_TITLE = 'Bus Ticket Booking System';
export const SWAGGER_DESCRIPTION = 'Bus Ticket Booking System';
export const SWAGGER_VERSION = '1.0.0';
export const SWAGGER_SERVER = 'v1';
export const SWAGGER_SITE_TITLE = 'Bus Ticket Booking System';
